...
axs[0].plot(x_train, loss_train, label='Train')
axs[1].plot(x_train, accuracy_train, label='Train')
axs[1].plot(x_val, accuracy_val, label='Test')


axs[0].set_title('Loss', fontsize=20)
axs[1].set_title('Accuracy', fontsize=20)
axs[1].set_xlabel('Num epochs', fontsize=15)
